...
def mainproc(account=''):
    ...
    while LoopHere == True:
        ...
        #LoopMsg= 'Running Log -  Loop: Pos ' + str(CountLoop) + "/2"
        #inform(LoopMsg, msg_type='info')
    ...
    while True:
        for last in windows:
            ...
            try:
                ...
                inform('***Encontramos problemas para processar esta janela.','info')
# Call main function
main()
